...
constexpr uint64_t HYBM_HOST_CONN_START_ADDR = 0x300040000000UL; // 48T+1G
constexpr uint64_t HYBM_GVM_START_ADDR = 0x400000000000UL;       // 64T
constexpr uint64_t HYBM_GVM_END_ADDR = 0xA80000000000UL;         // 168T
constexpr uint64_t HYBM_HOST_CONN_ADDR_SIZE = HYBM_GVM_START_ADDR - HYBM_HOST_CONN_START_ADDR;
