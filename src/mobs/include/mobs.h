 ...
 */
#ifndef __MEMFABRIC_MOBS_H__
#define __MEMFABRIC_MOBS_H__
 ...
 */
int32_t mobs_init(uint32_t flags);
 ...
 * @return 0 if successful
 */
int32_t mobs_set_extern_logger(void (*func)(int level, const char *msg));
 ...
 * @return 0 if successful
 */
int32_t mobs_set_log_level(int level);
 ...
 */
const char *mobs_get_last_err_msg();
 ...
 * @return last error message
 */
const char *mobs_get_and_clear_last_err_msg();
