 ...
 */
#ifndef MEMFABRIC_HYBRID_EMB_LAST_ERROR_H
#define MEMFABRIC_HYBRID_EMB_LAST_ERROR_H
...
inline void LastError::Set(const char *msg)
{
    msg_ = msg;
    have_ = true;
}

inline const char *LastError::GetAndClear(bool clear)
{
...
#endif // MEMFABRIC_HYBRID_EMB_LAST_ERROR_H