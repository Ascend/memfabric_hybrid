...
def test_alltoall(dist_type, case_list):
    ...
    try:
        ...
        for data_len in case_list:
            golden_dir = f"alltoall_{data_len}_{world_size}"
            output_dir = f"{current_dir}/output/{data_len}/{global_rank}/"
            ...
            for i in range(0, 15):
                ...
                tensor_input = torch.from_numpy(data).to(tensor_data_type).npu()
...
if __name__ == "__main__":
    ...
    test_alltoall(dist_type, case_list)