...
// 地址基值常量
constexpr uint64_t TEST_GVA_BASE_HOST = HYBM_HOST_CONN_START_ADDR + TEST_OFFSET_SIXTEEN_MB;
constexpr uint64_t TEST_GVA_BASE_DEVICE = HYBM_GVM_START_ADDR + TEST_OFFSET_SIXTEEN_MB;
