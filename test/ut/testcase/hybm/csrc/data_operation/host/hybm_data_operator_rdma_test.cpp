...
protected:
    ...
    static void TearDownTestSuite()
    {
        ...
        g_transportManager->CloseDevice();
        hybm_uninit();
    }
...
class HybmDataOpRdmaIpv6Test : public ::testing::Test {
protected:
    static void SetUpTestSuite()
    {
        auto ret = hybm_init(0, 0);
...
TEST_F(HybmDataOpRdmaIpv6Test, DataCopy_ShouldReturnSuccess)
{
    int ret = 0;
    ExtOptions options{};
    options.flags = 0;
...
TEST_F(HybmDataOpRdmaIpv6Test, DataCopy2d_ShouldReturnSuccess)
{
    int ret = 0;
    ExtOptions options{};
    options.flags = 0;
...
TEST_F(HybmDataOpRdmaIpv6Test, CopyAsync)
{
    EXPECT_EQ(g_dataOperator->Initialize(), BM_OK);
    int ret = 0;
    ExtOptions options{};
...
TEST_F(HybmDataOpRdmaIpv6Test, DataCopyErrorBranch)
{
    int ret = 0;
    ExtOptions options{};
    options.flags = 0;
...
TEST_F(HybmDataOpRdmaIpv6Test, ErrorBranch)
{
    g_dataOperator->UnInitialize();
    MOCKER_CPP(&DlAclApi::AclrtCreateStream, int32_t(*)(void **)).stubs().will(returnValue(1));
    int ret = g_dataOperator->Initialize();
